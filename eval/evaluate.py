...
parser.add_argument('--pred_path', type=str, default="/home/dslstt/tools/results/dslstt_Swin_TINY/ViSha")
parser.add_argument('--ema', action='store_true')
parser.set_defaults(ema=False)
args = parser.parse_args()

gt_path = '/home/dataset/ViSha/test/labels'

args.save_path = args.pred_path
pred_path = os.path.join(args.pred_path, "dslstt_Swin_TINY_ckpt_{}".format(str(args.epoch)))
if args.ema:
